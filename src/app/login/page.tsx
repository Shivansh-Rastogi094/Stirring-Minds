    ...
    <div className="container mx-auto px-8 min-h-[80vh] flex items-center justify-center">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-3xl font-black tracking-tight mb-2 text-gradient-blue">Welcome Back</h1>
          <p className="text-sky-50/65 text-sm">Access your exclusive startup benefits.</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-sky-50/65">
          ...
          <Link href="/register" className="font-bold text-gradient-blue hover:underline">
            Register for free
          </Link>
        </p>
      </motion.div>
